...
const Signin = () => {
  ...
  return (
    <div className="bg-[url('https://i.postimg.cc/5tv1Xnj4/11.png')]">
      <div className="min-h-screen flex fle-col items-center justify-center py-6 px-4 raleway">
        <div className="grid md:grid-cols-2 items-center gap-10 max-w-6xl max-md:max-w-md w-full">
          ...
          <form onSubmit={handleSignin} className="max-w-md md:ml-auto w-full">
            ...
            <p className="text-center mt-4 text-slate-400 ">
              ...
              <Link to={'/signUp'} className="text-blue-600 underline ml-1">Register here</Link>
            </p>
          </form>
        </div>
      </div>
